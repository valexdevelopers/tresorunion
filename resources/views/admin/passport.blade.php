                    ...
                    <div class="content-i">
                        <div class="content-box">
                            <div class="element-wrapper">
                                <h6 class="element-header">Change Account Passport</h6>
                                @if($errors->any())
                                ...
                                <div class="element-box">
                                    <form method="POST" action="{{ route('admin.user.passport.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <h5 class="form-header">Change Passport</h5>
                                        <div class="row">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('passport') is-invalid @enderror" accept="image" required="required" type="file" name="passport">
                                                    @error('passport') 
                                        ...
                                        <div class="form-buttons-w">
                                            <button class="btn btn-primary" type="submit" name="register">Update Passport</button>
                                        </div>
                                    </form>
