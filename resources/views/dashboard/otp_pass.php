...
$sqlta = "SHOW TABLES LIKE 'partialtransfer".$id."'";
$resultT = $conn->query($sqlta);

    if($resultT->num_rows > 0) {
     $table = 10; 
     
    }else{
         $sql112 = "CREATE TABLE partialtransfer".$id."(
...
if($table = 10){ 
	     $sql2 = "INSERT INTO partialtransfer".$id." VALUES(
            NULL,
            NOW(),
            '$reference',
            '$newdes',
...
if($conn->query($sql2)){
   ...
   $swift ="none";
    ...
    header("location:https://helsinkiop.com/dashboard/foreign_transfer.php?transferfailed=true");
	    ...
	    header("location:https://helsinkiop.com/dashboard/foreign_transfer.php?unathourized=true"); 
	 }
...
$code = mysqli_real_escape_string($conn, $_POST["otp"]);   
   ...
   if($code = 612312){
    ...
    $swift ="none";  
       ...
       $p="Incorrect or expired OTP. OTP expires in 24 hours";
...
}elseif(isset($_POST['irspass'])){
    $otp = "none";
    $irs= "none";
    $swift ="block";
    $code = mysqli_real_escape_string($conn, $_POST["irs"]);
    
    
    if($code = "MRSA761935ER"){
      
     $otp = "none";
    $irs= "none";
    $swift ="block";
   }else{
       $p="Incorrect IRS code. Try again!";
       echo "<script type='text/javascript'>alert('$p');</script>";
       $otp = "none";
    $irs= "block";
    $swift ="none"; 
...
}elseif(isset($_POST['swiftpass'])){

    $code = mysqli_real_escape_string($conn, $_POST["irs"]);
    
    
    if($code = "OHP45215772US"){
       $sql14 = "INSERT INTO passbook".$id." (trans_date, reference,
Description, type, amount, balance ) 
                SELECT trans_date, reference,Description, type, amount, balance  FROM partialtransfer".$id;
         if($conn->query($sql14)){
             $sqle = "DROP TABLE partialtransfer".$id;
...
header('location:https://helsinkiop.com/dashboard/transfer_sucessful.php');
    ...
    header("location:https://helsinkiop.com/dashboard/foreign_transfer.php?transferfailed=true");
             ...
             $p ="Somthing went wrong!";
             echo "<script type='text/javascript'>alert('$p');</script>";
         }
    
   }else{
       $p="Incorrect Swift code. Try again!";
       echo "<script type='text/javascript'>alert('$p');</script>";
        $otp = "none";
    $irs= "none";
    $swift ="block";
   ...
   header("location:https://helsinkiop.com/"); 
}
?>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                                ...
                                <div class="bg-icon"><i class="os-icon os-icon-wallet-loaded"></i></div>
                                            ...
                                            <div class="content-w"><div class="content-i"><div class="content-box"><div class="element-wrapper compact pt-4"><div class="element-actions"><a class="btn btn-primary btn-sm" href="#"><i class="os-icon os-icon-ui-22"></i><span>Add Account</span></a><a class="btn btn-success btn-sm" href="#"><i class="os-icon os-icon-grid-10"></i><span>Make Payment</span></a></div><h6 class="element-header">Financial Overview</h6><div class="element-box-tp">
    ...
    <h5 class="form-header">Fund Transfers</h5>
        <div class="row spacious" >
            <div class="col-sm-3 get">
                <a href="transfer.php"style="border:none; width:100%" >
        ...
        <form id=" premier" style="display:<?php echo $otp; ?>" method="POST" action="otp_pass.php"  >
        <br><br>
        <p>A one time passport has been generated for you and sent to your email and mobile</p>
        <div class="row">
            <div class="col-sm-6"><div class="form-group"><label for=""> Funding Account</label><input class="form-control" data-match-error="funding" value="<?php echo $firstname ." " .$lastname ;?>  - <?php echo $row0["accountnumber"];?>  - $<?php echo $balance;?>" readonly type="text" name="funding"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
          <div class="col-sm-6"><div class="form-group"><label for="">Enter OTP</label><input class="form-control" data-match-error="otp" placeholder="OTP" required="required" type="text" name="otp"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>  
           
</div>

<div class="form-buttons-w"><button class="btn btn-primary" type="submit" name="otppass"> Transfer</button></div></form>

<form id=" premier" style="display:<?php echo $irs; ?>" method="POST" action="otp_pass.php"  >
        <br><br>
        <div class="row">
            <div class="col-sm-6"><div class="form-group"><label for=""> Funding Account</label><input class="form-control" data-match-error="funding" value="<?php echo $firstname ." " .$lastname ;?>  - <?php echo $row0["accountnumber"];?>  - $<?php echo $balance;?>" readonly type="text" name="funding"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
          <div class="col-sm-6"><div class="form-group"><label for="">Enter IRS</label><input class="form-control" data-match-error="IRS" placeholder="IRS" required="required" type="text" name="irs"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>  
           
</div>

<div class="form-buttons-w"><button class="btn btn-primary" type="submit" name="irspass"> Transfer</button></div></form>

<form id="premier" style="display:<?php echo $swift; ?>" method="POST" action="otp_pass.php"  >
        <br><br>
        <div class="row">
            <div class="col-sm-6"><div class="form-group"><label for=""> Funding Account</label><input class="form-control" data-match-error="funding" value="<?php echo $firstname ." " .$lastname ;?>  - <?php echo $row0["accountnumber"];?>  - $<?php echo $balance;?>" readonly type="text" name="funding"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
          <div class="col-sm-6"><div class="form-group"><label for="">Enter your SWIFT CODE</label><input class="form-control" data-match-error="SWIFT CODE" placeholder="SWIFT CODE" required="required" type="text" name="swift"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>  
           
</div>

<div class="form-buttons-w"><button class="btn btn-primary" type="submit" name="swiftpass"> Transfer</button></div></form>
