                                ...
                                <div class="left_page_content">
                                    ...
                                    <div class="transfer_form_wrap">
                                        ...
                                        <div class="transfer_form" id="intra_form">
                                            <div class="no_data">
                                                <p style="text-align: center; width: 60%; margin: 0 auto; font-weight: 600;">You have no standing Orders. Contact Support to set up a standing order</p>
                                            </div>
                                        </div>
