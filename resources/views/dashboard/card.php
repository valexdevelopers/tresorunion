...
<div class="col-lg-4 col-xxl-5">
    ...
    <h5 class="form-header">Apply for Cards</h5>
       
        <form id="premier" method="POST" action="cards.php"  >
        ...
        <div class="row">
           ...
           <div class="col-sm-6"><div class="form-group"><label for="">Card Type</label>
               <select class="form-control"  name="country">
       <option value="platinium">Helsinki Op Platinium Card</option>
       <option value="mastercard">Helsinki Op Gold Card</option>
       <option value="mastercard">Helsinki Op Master Card</option>
...
<div class="row">
    <div class="col-sm-6"><div class="form-group"><label for="">Purpose of Card</label><input class="form-control" data-match-error="Purpose" placeholder="Purpose" required="required" type="text" name="purpose"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
     <div 
class="col-sm-6"><div class="form-group"><label for=""> Name on card </label><input class="form-control" type="text" data-error="" placeholder="" required="required" name="daccountnumber"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
    </div>


<div class="form-buttons-w"><button class="btn btn-primary" type="submit" name="apply"> Proceed</button></div></form>
