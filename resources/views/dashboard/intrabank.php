    ...
    <h5 class="form-header">Fund Transfers</h5>
        <div class="row spacious" >
            <div class="col-sm-3 get">
                <a href="#"style="border:none; width:100%" >
        ...
        <form id=" premier" method="POST" action="processing.php"  >
         <div id="none-pin">
        <div class="row">
            ...
            <div 
class="col-sm-6"><div class="form-group"><label for=""> Destination Account </label><input class="form-control" type="text" data-error="Please input  Account Number" placeholder="Account Number" required="required" name="daccountnumber"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
</div>

<div class="row">
    <div class="col-sm-6"><div class="form-group"><label for="">Destination Account Holder</label><input class="form-control" data-match-error="Account Holder" placeholder="Account Holder" required="required" type="text" name="holder"><div class="help-block form-text with-errors form-control-feedback"></div></div></div>
...
<div class="form-buttons-w"><button class="btn btn-primary" type="submit" name="premier"> Transfer</button></div>
