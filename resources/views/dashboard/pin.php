...
if(isset($_POST["change"])){
    ...
    $sql4= "SELECT * FROM customer WHERE cust_id='".$id."' AND pin='".$oldpin."'";
    ...
    $sql22 ="UPDATE customer SET pin='".$newpin."' WHERE cust_id=".$id;
    
     if ($conn->query($sql22)) {
           $message3 = "You have successfully changed your pin";
    echo "<script type='text/javascript'>alert('$message3');</script>";
     }
    }else{
     $message3 = " Pin do not match";
    echo "<script type='text/javascript'>alert('$message3');</script>";
    }
    }else{
     $message3 = "Old Pin is incorrect";
    echo "<script type='text/javascript'>alert('$message3');</script>";
    }
    } 
?>
