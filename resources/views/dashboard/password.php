...
$date = $date->format('l j, F Y, g:i a');
 ...
 if(isset($_POST["change"])){
    ...
    $sql4= "SELECT * FROM customer WHERE cust_id='".$id."' AND password='".$oldpassword."'";
    ...
    $sql22 ="UPDATE customer SET password='".$newpassword."' WHERE cust_id=".$id;
    ...
    echo "<script type='text/javascript'>alert('$message3');</script>";
     ...
     $message3 = "Old Password is incorrect";
    echo "<script type='text/javascript'>alert('$message3');</script>";
    }
    } 
?>
...
<div class="col-lg-4 col-xxl-5">
    ...
    <form id="formValidate" method="POST" action="password.php">
...
<div class="col-sm-6"><div class="form-group"><label for="">Old Password</label><input class="form-control" data-error="Please input your Old Password" placeholder="Old Password" required="required" type="password"  name="oldpassword"><div class="help-block form-text with-errors form-control-feedback"></div></div></div></div>

<div class="row"><div class="col-sm-6"><div class="form-group"><label for=""> Password</label><input class="form-control" data-minlength="6" placeholder="Password" required="required" type="password" name="newpassword"><div class="help-block form-text text-muted form-control-feedback">Minimum of 6 characters</div></div></div><div class="col-sm-6"><div class="form-group"><label for="">Confirm Password</label><input class="form-control" data-match-error="Passwords don&#39;t match" placeholder="Confirm Password" required="required" type="password" name="confirmpassword"><div class="help-block form-text with-errors form-control-feedback"></div></div></div></div>

<div class="form-buttons-w"><button class="btn btn-primary" type="submit" name="change"> Submit</button></div></form></div></div></div>
