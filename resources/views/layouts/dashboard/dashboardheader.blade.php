    ...
    <div class="fancy-selector-w">
        <div class="fancy-selector-current">
            ...
            <div class="fs-main-info">
                <div class="fs-name">
                    Tresor Platinum Card
                </div>
                <div class="fs-sub">
                    <span>Balance:</span>
                    <b style="color: white; font-weight: 900;font-size: 14px;">$34555</b>
                </div>
            </div>
        ...
        <div class="fancy-selector-options">
            ...
            <div class="fancy-selector-option active">
                ...
                <div class="fs-main-info">
                    ...
                    <div class="fs-sub">
                        <span>Balance:</span>
                       <b style="color: white; font-weight: 900;font-size: 14px;">$5,111</b>
                    </div>
                </div>
                <div class="fs-extra-info">
                    <strong>2523</strong>
            ...
            <div class="fancy-selector-option">
                ...
                <div class="fs-main-info">
                    ...
                    <div class="fs-sub">
                        <span>Balance:</span>
                        <b style="color: white; font-weight: 900;font-size: 14px;">$1,004</b>
                    </div>
                </div>
                <div class="fs-extra-info">
                    <strong>6345</strong>
