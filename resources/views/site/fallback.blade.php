...
<!-- Top -->
    ...
    <div class="page_header_wrapper" style="height: 71px;"><div class="header-wrapper2 page_header affix-top">
    <div id="fixblock" class="fixblock">
        <div class="container">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12"><a class="logo" href="/"><img src="images/logo_2.png" alt=""></a></div>
                    <nav class="menu col-lg-6 col-md-6 col-sm-4 col-xs-12">
                        <div class="menu-button"><i class="fa fa-bars"></i><span class="touch-button"></span></div>
                            <ul class="flexnav lg-screen" data-breakpoint="">
                                <li><a href="/">Home</a></li>
                                <li class="item-with-ul"><a href="#features">Features</a>
                                ...
                                <li class="item-with-ul"><a href="#services">Services</a>
                                    <ul style="display: none;"> 
                                        <li> 
                                ...
                                <span class="touch-button"></span></li>
                                <li class="item-with-ul"><a class="active" href="#pages">Pages</a>
                                    <ul style="display: none;"> 
                                        <li> 
                                ...
                                <span class="touch-button"></span></li>
                                <li class="item-with-ul"><a href="#blog">Blog</a>
                                    <ul style="display: none;"> 
                                        <li> 
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12"><a class="button_flat button_flat_menu" href="#">Find adviser</a></div>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="breadcrumbs">  
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <a class="first_element" href="/">Home</a><a href="#features">Pages</a><span>404</span>
                    </div>
                </div>
            </div>
        </div>
